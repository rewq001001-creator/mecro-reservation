...
- GitHub Actions가 오전 7:55부터 8:30까지 여러 번 트리거되어, 스케줄 지연이나 누락을 최대한 흡수합니다.
...
GitHub Actions의 `schedule`은 완전히 초 단위로 정확하지 않고 몇 분 지연되거나 누락될 수 있습니다. 현재 구성은 이를 줄이기 위해 07:55~08:30 구간에 여러 번 트리거되도록 보강되어 있습니다.
